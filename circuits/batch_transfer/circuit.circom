...
// Batch private transfer circuit supporting 2 token transfers in a single proof.
// Each transfer can be for a different mint/pool, allowing users to transfer multiple different zTokens atomically.
// This solves the transaction size issue for DEX add_liquidity operations.
//
...
template BatchTransferCircuit2() {
    // Transfer 0 inputs
...
component main = BatchTransferCircuit2();
